...
const UnitedKingdom = () => {
  return (
    <>
    <Header bg={true}/>
    <Banner title="Study In United Kingdom"/>
    ...
    <div className="study-content">
        ...
        <h1 className="study-header-title">The United Kingdom</h1>
        <p className="study-header-tagline">Score 8+ Bands with Certified and experienced SK Classes Coach
</p>
        <p className="study-header-desc">When it comes to world-class education, United Kingdom stands as a beacon of excellence, offering a welcoming environment, top-tier institutions, and a diverse cultural tapestry. Studying in United Kingdom isn’t just about gaining a degree.</p>
         <p className="study-header-desc">When it comes to world-class education, United Kingdom stands as a beacon of excellence, offering a welcoming environment, top-tier institutions, and a diverse cultural tapestry. Studying in United Kingdom isn’t just about gaining a degree.</p>
        </div>

        <div className="study-hero">
        <img src="https://www.riotgames.com/darkroom/1440/cc664035db57e98ca6a28e86c3ada50f:b4614fff3f624da0c7842bfae18bc052/london-office-page.png" />
        </div>
